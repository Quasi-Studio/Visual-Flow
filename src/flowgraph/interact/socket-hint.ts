...
class SocketHint {
    ...
    constructor () {
        ...
        this.text_svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg')

        this.text_path = document.createElementNS('http://www.w3.org/2000/svg', 'path')
        this.text_path.setAttribute('fill', SocketHint.text_background_color.tertiary.hex())
    ...
    display(soc: Socket, mouse_pos: Point): void {
        ...
        Point.add(mouse_pos, new Point(5, - size.height)).apply(this.text_svg, 'left-top')
